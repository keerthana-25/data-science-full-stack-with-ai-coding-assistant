...
Synthetic tabular + text + image-signal benchmark. See `DATASET.md` for the offline reproduction note.
...
Open `14_autogluon_multimodal_automl_suite/dashboard.html` in a browser after the run.
