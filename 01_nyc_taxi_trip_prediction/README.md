...
NYC Taxi Trip Duration (Kaggle). See `DATASET.md` for the offline reproduction note.
...
Open `01_nyc_taxi_trip_prediction/dashboard.html` in a browser after the run.
