...
Mall Customer Segmentation style data. See `DATASET.md` for the offline reproduction note.
...
Open `03_customer_segmentation_clustering/dashboard.html` in a browser after the run.
