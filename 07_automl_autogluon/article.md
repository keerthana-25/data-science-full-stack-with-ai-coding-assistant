# Reproducing AutoML Model Tournament on a Normal Laptop
...
The main idea is automated model selection. I started from the supplied prompt, identified the core experiment, and used a small offline dataset so that another student or grader can reproduce it without special credentials.
