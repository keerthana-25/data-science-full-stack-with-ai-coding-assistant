...
NYC TLC style synthetic trip data. See `DATASET.md` for the offline reproduction note.
...
Open `13_crispdm_nyc_taxi_audit_platform/dashboard.html` in a browser after the run.
